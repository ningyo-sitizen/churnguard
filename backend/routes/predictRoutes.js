...
const {getPrediction,getUserDetail,nosave,yessave,analytics,getPredictionHistory,getPredictionDashboardHistory,deletePrediction} = require("../controller/predictionController")
...
router.post("/delete",verifyToken,checkrole("user"),deletePrediction)
