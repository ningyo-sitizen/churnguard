...
UTIL_DIR = os.path.join(BASE_DIR, "app", "utils")

model = pickle.load(open(os.path.join(MODEL_DIR, "model.pkl"), "rb"))
scaler_model = pickle.load(open(os.path.join(UTIL_DIR, "scaler_model.pkl"), "rb"))
scaler_cluster = pickle.load(open(os.path.join(UTIL_DIR, "scaler_cluster.pkl"), "rb"))
kmeans = pickle.load(open(os.path.join(MODEL_DIR, "kmeans.pkl"), "rb"))
